...
type Props = CartItem & {
  increase: (value: CartItem) => void;
  decrease: (value: CartItem) => void;
  removeProduct: (value: CartItem) => void;
};

const CartItem = ({ title, price, quantity, id, description, category, increase, decrease, removeProduct }: Props) => {
